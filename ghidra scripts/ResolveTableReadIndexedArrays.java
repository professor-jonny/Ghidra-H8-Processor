// Resolves array-base indirection for table_read_indexed (0x14880), same
// technique as review.md item 22 (originally applied to table_lookup_indexed),
// generalized per that item's own method note.
// @category H8539F
...
public class ResolveTableReadIndexedArrays extends GhidraScript {

	@Override
	public void run() throws Exception {
		Address targetFunc = toAddr(0x14880);
		Function f = getFunctionAt(targetFunc);
		if (f == null) {
			println("ERROR: function not found at 0x14880");
			return;
		}
		...
		println("Found " + callSites.size() + " call sites to table_read_indexed");
