...

{
  ...
  uVar4 = (uint)a_lo * (uint)*(ushort *)((int)&stack0xfffe + 10);
  iVar5 = (uint)a_hi * (uint)*(ushort *)((int)&stack0xfffe + 10) + (uVar4 >> 0x10);
  uVar1 = (short)uVar4 << 1;
  sVar2 = (short)iVar5 * 2;
...

{
  ...
  uVar1 = (uint)a_lo * (uint)*(ushort *)((int)&stack0xfffe + 10);
  iVar2 = (uint)a_hi * (uint)*(ushort *)((int)&stack0xfffe + 10) + (uVar1 >> 0x10);
...

{
  ...
  egr_table_row_lookup_f496(DAT_0001f1e8,param_2,param_3);
  sVar2 = (*(code *)0x18a55)();
  uVar4 = extraout_R2;
  if (sVar2 != 0) {
  ...
  *(undefined2 *)((int)&stack0xfffe + -2) = 0;
  if ((DAT_0001f1f2 & 0x4000) != 0) {
    if ((DAT_000102e9 == '\x03') || (DAT_000102e9 == '\x04')) {
      uStack_8 = calc_load_correction_f10e();
      if (uStack_8 == 1) {
        uVar4 = 0x80;
      }
...

{
  ...
  uVar6 = 0;
  uStack_10 = table_1e4a_lookup_with_f2d6_d8_reset();
  ...
  uVar2 = muldiv_u16_scaled(uVar2,b,uStack_10 * *(short *)((int)&stack0xfffe + -0x10),0x4000);
  sVar4 = 6;
  do {
    c = c << 1;
    if (c == 0) break;
...
{
  if ((((g_status_flags_f20e & 0x10) != 0) || (DAT_0001f10e != DAT_00010f66)) ||
     (DAT_0001f10a <= DAT_0001f10c)) {
    DAT_0001f00c = DAT_00010f64 * 0x50;
  }
  if ((DAT_0001f1fe & 0x10) == 0) {
    if (((DAT_0001f1fe & 1) != 0) && (DAT_00010f4e <= DAT_0001ef78)) {
      if (DAT_0001f09a != 0) {
        return 0;
      }
      DAT_0001f1fe = DAT_0001f1fe | 0x10;
      return 0;
    }
    if ((g_status_flags_f20e & 0x10) != 0) {
      return 2;
...
{
  if ((DAT_0001f1f2 & 0x80) != 0) {
    if ((g_status_flags_f3a4 & 0x400) == 0) {
      return 2;
    }
    if ((DAT_0001f200 & 1) != 0) {
      return 0;
...

{
  ...
  if (((DAT_0001f1f2 & 0x2000) == 0) || ((DAT_0001f4ae & 10) == 0)) {
    uVar1 = 1;
  }
  else {
    uVar1 = 0;
...

{
  ...
  if (((DAT_0001f1f2 & 0x2000) == 0) || ((DAT_0001f4ae & 5) == 0)) {
    uVar1 = 1;
  }
  else {
    uVar1 = 0;
